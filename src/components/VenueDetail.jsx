...
const VenueDetail = () => {
  ...
  useEffect(() => {
    // ID sonundaki :1 hatasini temizle
                  ...
                  <div className="panel-body">
                    {venue.coordinates && (
                      <img className="img-responsive img-rounded" alt="Konum"
                        src={`https://maps.googleapis.com/maps/api/staticmap?center=${venue.coordinates[1]},${venue.coordinates[0]}&zoom=15&size=600x400&markers=${venue.coordinates[1]},${venue.coordinates[0]}&key=AIzaSyCmmKygTpBzHGOZEciJpAdxC9v_tWHagnE`}
                      />
                    )}
                  </div>
                </div>
              ...
              <div className="col-xs-12">
                <div className="panel panel-primary">
                  <div className="panel-heading">
                    <NavLink className="btn btn-default pull-right" to={`/venue/${id}/comment/new`} state={{ name: venue.name }}>
                      Yorum Ekle
                    </NavLink>
